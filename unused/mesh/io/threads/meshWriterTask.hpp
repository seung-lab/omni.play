...
private:
    ...
    writeOutData(meshChunkDataWriter* chunk_data,
                 boost::shared_ptr<dataForMeshLoad> data,
    ...
    void printInfoAboutSkippedSegment(boost::shared_ptr<dataForMeshLoad>)
    {
