...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Oct 24 16:37:33 2011
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -Isrc -Iinclude -Ilib -Iexternal/zi_lib -Iinclude/yaml-cpp/include -Iinclude/libb64/include -I../omni.common/lib/include -Iexternal/libs/Boost/include -Iexternal/libs/thrift/include/thrift -Iexternal/libs/libjpeg/include
LINK          = g++
LFLAGS        = -DZI_USE_OPENMP -fopenmp -gstabs+
LIBS          = $(SUBLIBS)   ../omni.common/lib/bin/libomni.common.a external/libs/Boost/lib/libboost_filesystem.a external/libs/Boost/lib/libboost_iostreams.a external/libs/Boost/lib/libboost_system.a external/libs/Boost/lib/libboost_thread.a external/libs/thrift/lib/libthrift.a external/libs/libjpeg/lib/libturbojpeg.a 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
build/b64dec.o: include/libb64/src/b64dec.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/b64dec.o include/libb64/src/b64dec.c

build/b64enc.o: include/libb64/src/b64enc.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/b64enc.o include/libb64/src/b64enc.c

build/cdecode.o: include/libb64/src/cdecode.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/cdecode.o include/libb64/src/cdecode.c

build/cencode.o: include/libb64/src/cencode.c 
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/cencode.o include/libb64/src/cencode.c

build/decoder.o: include/libb64/src/decoder.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/decoder.o include/libb64/src/decoder.cc

build/encoder.o: include/libb64/src/encoder.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/encoder.o include/libb64/src/encoder.cc
...
build/jpeg.o: src/jpeg/jpeg.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/jpeg.o src/jpeg/jpeg.cpp
