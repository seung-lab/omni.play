#############################################################################
# Makefile for building: libomni.server.a
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Oct 4 15:47:26 2011
...
OBJECTS       = build/colors.o \
		...
		build/yaml.o \
		build/gl.o \
		build/channelDataWrapper.o \
		build/omFileHelpers.o \
		build/omPrimeNumbers.o \
		build/omSystemInformation.o \
...
build/channelDataWrapper.o: src/utility/channelDataWrapper.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/channelDataWrapper.o src/utility/channelDataWrapper.cpp

build/omFileHelpers.o: src/utility/omFileHelpers.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/omFileHelpers.o src/utility/omFileHelpers.cpp

build/omPrimeNumbers.o: src/utility/omPrimeNumbers.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/omPrimeNumbers.o src/utility/omPrimeNumbers.cpp

build/omSystemInformation.o: src/utility/omSystemInformation.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/omSystemInformation.o src/utility/omSystemInformation.cpp
