...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Tue Oct 4 17:47:30 2011
...
install_inst: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/Users/balkamm/temp/omni.common/lib/bin/ || $(MKDIR) $(INSTALL_ROOT)/Users/balkamm/temp/omni.common/lib/bin/ 
	cd src; find -regex ".*\.h\(pp\)?" -print0 | cpio --null -pvd ../lib/include/common/
