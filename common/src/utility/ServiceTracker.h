...
class ServiceTracker {
 ...
 public:
  ...
  ServiceTracker(facebook::fb303::FacebookBase *handler,
                 ...
                 bool featureCheckpoint = true, bool featureStatusCheck = true,
                 bool featureThreadCheck = true,
                 Stopwatch::Unit stopwatchUnit = Stopwatch::UNIT_MILLISECONDS);
...
class ServiceMethod {
 ...
 public:
  ServiceMethod(ServiceTracker *tracker, const std::string &name,
                const std::string &signature, bool featureLogOnly = false);
  ServiceMethod(ServiceTracker *tracker, const std::string &name, uint64_t id,
