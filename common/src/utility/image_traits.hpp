...
template <int D>
dimension<D> dimension<D>::ONE = dimension<D - 1>::ONE[1];

template <int D>
dimension<D> dimension<D>::ZERO = dimension<D - 1>::ZERO[0];
