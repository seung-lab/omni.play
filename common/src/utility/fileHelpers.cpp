...
void fileHelpers::MoveFile(const std::string& from_fnp,
                           const std::string& to_fnp) {
  if (!exists(from_fnp)) {
...
void fileHelpers::CopyFile(const std::string& from_fnp,
                           const std::string& to_fnp) {
...
void fileHelpers::MoveAllFiles(const std::string& fromDir,
...
void fileHelpers::Symlink(const std::string& fromDir,
                          const std::string& toDir) {
...
void fileHelpers::RmFile(const std::string& fileName) { remove(fileName); }
