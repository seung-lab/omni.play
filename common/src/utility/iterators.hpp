...
typedef boost::transform_iterator<std::function<coords::Data(const Vector3i&)>,
...
filtered_dataval_iterator<T> make_filtered_dataval_iterator(
  ...
  return filtered_dataval_iterator<T>(filter,
                                      make_dataval_iterator(voxels, from, to));
}
...
make_segset_chunkfiltered_dataval_iterator(coords::Data from, coords::Data to,
                                           coords::Data curr,
                                           chunk::Voxels<common::SegID>& voxels,
