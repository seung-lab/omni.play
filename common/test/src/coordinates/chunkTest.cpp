...
TEST(Coords_Chunk, ChildrenCoords)
{
	...
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,2,2,2)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,2,2,3)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,2,3,2)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,3,2,2)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,2,3,3)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,3,3,2)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,3,2,3)));
	ASSERT_NE(children.end(), std::find(children.begin(), children.end(), Chunk(0,3,3,3)));
}
