...
private:
	const boost::shared_ptr<OmBrushOppCircle> circle_;
	const ViewType viewType_;
	const int brushDia_;

public:
	OmBrushOppLine(boost::shared_ptr<OmBrushOppCircle> circle)
		: circle_(circle)
	...
	void LineOpp(const DataCoord& first, const DataCoord& second)
	{
