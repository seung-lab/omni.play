...
//	OmStateManager::SetViewCenter(Vector3f(0,0,0));
	...
	qtView2d_xy = new OmView2d(XY_VIEW, CHANNEL, 1, 1);
	qtView2d_xz = new OmView2d(XZ_VIEW, CHANNEL, 1, 1);
	qtView2d_yz = new OmView2d(YZ_VIEW, CHANNEL, 1, 1);
	
	qtView2d_xy_s = new OmView2d(XY_VIEW, SEGMENTATION, 1, 1);
	qtView2d_xz_s = new OmView2d(XZ_VIEW, SEGMENTATION, 1, 1);
	qtView2d_yz_s = new OmView2d(YZ_VIEW, SEGMENTATION, 1, 1);
