...
class OmView2d:public QWidget,
    ...
    public OmSystemModeEventListener, public OmPreferenceEventListener, public OmVoxelEventListener {
 Q_OBJECT public:
	OmView2d(ViewType viewtype, ObjectType voltype, OmId image_id, OmId second_id, OmId third_id =
		 0, QWidget * parent = 0);
 ...
 protected:
	...
	OmIds setMyColorMap(OmId segmentation, SEGMENT_DATA_TYPE * imageData, Vector2 < int >dims,
			    const OmTileCoord & key, void **rData);
