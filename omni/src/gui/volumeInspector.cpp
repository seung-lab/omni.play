...
{ 
	...
	scaleEdit->setText("[" + QString::number(scale.x) + " " + QString::number(scale.y) + " " + QString::number(scale.z) + "]");
	
	Vector3<float> res = OmVolume::GetDataResolution();
	resolutionEdit->setText("[" + QString::number(res.x) + " " + QString::number(res.y) + " " + QString::number(res.z) + "]");
	...
	extentEdit->setText("[" + QString::number(dimen.x) + " " + QString::number(dimen.y) + " " + QString::number(dimen.z) + "]");
