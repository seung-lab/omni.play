...
QT_BEGIN_NAMESPACE class Ui_preferences2d {
 public:
	...
	void setupUi(QWidget * preferences2d) {
		...
		QObject::connect(transparencySlider, SIGNAL(valueChanged(int)), transparencySliderLabel,
				 SLOT(setNum(int)));
	...
	void retranslateUi(QWidget * preferences2d) {
		...
		groupBox->
		    setTitle(QApplication::
			     translate("preferences2d", "Display Properties", 0, QApplication::UnicodeUTF8));
		alphaLabel->setText(QApplication::translate("preferences2d", "Alpha:", 0, QApplication::UnicodeUTF8));
		transparencySliderLabel->
		    setText(QApplication::translate("preferences2d", "0", 0, QApplication::UnicodeUTF8));
		infoCheckBox->
		    setText(QApplication::translate("preferences2d", "Show Information", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		groupBox_2->setToolTip(QApplication::translate("preferences2d", "(mB)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		groupBox_2->
		    setTitle(QApplication::
			     translate("preferences2d", "Cache Properties", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		volLabel->setToolTip(QApplication::translate("preferences2d", "(MB)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		volLabel->
		    setText(QApplication::
			    translate("preferences2d", "Volume Cache Size:", 0, QApplication::UnicodeUTF8));
		volEdit->setText(QString());
#ifndef QT_NO_TOOLTIP
		cacheLabel->setToolTip(QApplication::translate("preferences2d", "(MB)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		cacheLabel->
		    setText(QApplication::translate("preferences2d", "Tile Cache Size:", 0, QApplication::UnicodeUTF8));
		tileEdit->setText(QString());
#ifndef QT_NO_TOOLTIP
		depthLabel->
		    setToolTip(QApplication::translate("preferences2d", "(slices)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		depthLabel->
		    setText(QApplication::translate("preferences2d", "Depth Caching:", 0, QApplication::UnicodeUTF8));
		depthEdit->setText(QString());
#ifndef QT_NO_TOOLTIP
		sideLabel->
		    setToolTip(QApplication::translate("preferences2d", "(tiles)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		sideLabel->
		    setText(QApplication::translate("preferences2d", "Side Caching:", 0, QApplication::UnicodeUTF8));
		...
		mipLabel->
		    setText(QApplication::
			    translate("preferences2d", "Mip Level Caching:", 0, QApplication::UnicodeUTF8));
