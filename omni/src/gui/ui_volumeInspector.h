...
QT_BEGIN_NAMESPACE class Ui_volumeInspector {
 public:
	...
	void retranslateUi(QWidget * volumeInspector) {
		...
		groupBox->
		    setTitle(QApplication::
			     translate("volumeInspector", "Source Properties", 0, QApplication::UnicodeUTF8));
		nameLabel->setText(QApplication::translate("volumeInspector", "Name:", 0, QApplication::UnicodeUTF8));
		nameEdit->setText(QString());
		groupBox_2->
		    setTitle(QApplication::
			     translate("volumeInspector", "Volume Properties", 0, QApplication::UnicodeUTF8));
		scaleLabel->setText(QApplication::translate("volumeInspector", "Scale:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		resolutionLabel->
		    setToolTip(QApplication::translate("volumeInspector", "X, Y, Z", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		resolutionLabel->
		    setText(QApplication::
			    translate("volumeInspector", "Pixel Resolution:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		resolutionEdit->
		    setToolTip(QApplication::translate("volumeInspector", "X,Y,Z", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
		extentLabel->
		    setToolTip(QApplication::translate("volumeInspector", "(in pixels)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		extentLabel->
		    setText(QApplication::translate("volumeInspector", "Data Extent:", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		lengthLabel->
		    setToolTip(QApplication::translate("volumeInspector", "(in pixels)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		lengthLabel->
		    setText(QApplication::translate("volumeInspector", "Chunk Size:", 0, QApplication::UnicodeUTF8));
		sizeLabel->setText(QApplication::translate("volumeInspector", "size", 0, QApplication::UnicodeUTF8));
		groupBox_4->
		    setTitle(QApplication::
			     translate("volumeInspector", "Cache Properties", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		ramLabel->setToolTip(QApplication::translate("volumeInspector", "(MB)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		ramLabel->
		    setText(QApplication::translate("volumeInspector", "RAM Cache", 0, QApplication::UnicodeUTF8));
		ramSizeLabel->setText(QApplication::translate("volumeInspector", "size", 0, QApplication::UnicodeUTF8));
		vramSizeLabel->
		    setText(QApplication::translate("volumeInspector", "size", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
		vramLabel->setToolTip(QApplication::translate("volumeInspector", "(MB)", 0, QApplication::UnicodeUTF8));
#endif				// QT_NO_TOOLTIP
		vramLabel->
		    setText(QApplication::translate("volumeInspector", "VRAM Cache", 0, QApplication::UnicodeUTF8));
		addChannelButton->
		    setText(QApplication::translate("volumeInspector", "Add Channel", 0, QApplication::UnicodeUTF8));
		addSegmentationButton->
		    setText(QApplication::
			    translate("volumeInspector", "Add Segmentation", 0, QApplication::UnicodeUTF8));
