...
class MainWindow:public QMainWindow,
    ...
    public OmProgressEventListener, public OmAlertEventListener, public OmSystemModeEventListener {
 Q_OBJECT public:
	MainWindow();
 ...
 protected:
	...
	void updateComboBoxes(const OmId segmentationID = 0, const OmId segmentJustSelectedID = 0);
