...
#include "gui/sidebars/right/setValid.hpp"
#include "gui/sidebars/right/setNotValid.hpp"
#include "gui/sidebars/right/setUncertain.hpp"
#include "gui/sidebars/right/setNotUncertain.hpp"
#include "gui/sidebars/right/groupButtonTag.h"
#include "gui/sidebars/right/showValidatedButton.h"
#include "viewGroup/omViewGroupState.h"

ValidationGroup::ValidationGroup(DendToolBar* d, OmViewGroupState* vgs)
    : OmWidget(d)
    , vgs_(vgs)
