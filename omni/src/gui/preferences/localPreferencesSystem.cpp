    ...
    : QWidget(parent)
{
    ...
    connect(meshSlider, SIGNAL(valueChanged(int)),
            this, SLOT( on_meshSlider_valueChanged()));
    connect(tileSlider, SIGNAL(valueChanged(int)),
            this, SLOT(on_tileSlider_valueChanged()));

    connect(meshSlider, SIGNAL(sliderReleased()),
            this, SLOT( on_meshSlider_sliderReleased()));
    connect(tileSlider, SIGNAL(sliderReleased()),
