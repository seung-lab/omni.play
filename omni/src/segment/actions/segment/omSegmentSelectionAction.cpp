...
OmSegmentSelectionAction::OmSegmentSelectionAction(OmId segmentationId, OmId segmentId, bool state, bool append)
...
void OmSegmentSelectionAction::Action()
{
...
void OmSegmentSelectionAction::UndoAction()
{
	//get refs to volume and segmentation
	OmSegmentation & r_segmentation = OmVolume::GetSegmentation(mSegmentationId);
...
string OmSegmentSelectionAction::Description()
{
