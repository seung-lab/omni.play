...
OmSegmentStateAction::Action() {
	...
	OmEventManager::PostEvent(new OmSegmentEvent(OmSegmentEvent::SEGMENT_OBJECT_MODIFICATION, mSegmentationId, mSegmentIds));
}


void 
OmSegmentStateAction::UndoAction()	{ 
...
string 
OmSegmentStateAction::Description() {
