...
OmDataPath OmMSTold::getDendPath() {
	return OmDataPath(segmentation_->GetDirectoryPath() + "dend");
}

OmDataPath OmMSTold::getDendValuesPath() {
	return OmDataPath(segmentation_->GetDirectoryPath() + "dendValues");
}

OmDataPath OmMSTold::getEdgeDisabledByUserPath(){
	return OmDataPath(segmentation_->GetDirectoryPath() + "/edgeDisabledByUser");
};

OmDataPath OmMSTold::getEdgeForceJoinPath(){
	return OmDataPath(segmentation_->GetDirectoryPath() + "/edgeForceJoin");
};
