...
{
 public:
	virtual ~OmHdf5LowLevelWrappersAbstract() = 0;
	...
	virtual void dataset_image_create_tree_overwrite_with_lock(OmHdf5Path path, Vector3<int>* dataDims, Vector3<int>* chunkDims, int bytesPerSample, bool unlimited) = 0;
