...
private:
    ...
    void init()
    {
        ...
        numOfChunksToProcess_.set(numChunksTotal_);
    ...
    void addValuesFromChunkAndDownsampledChunks(const OmChunkCoord& mip0coord)
    {
        ...
        chunkCollectors_.insert(
            std::make_pair( mip0coord, new MipChunkMeshCollector( mip0coord,
                                                                  meshWriter_ )));
                        ...
                        const C& segIDs)
    {
        ...
        {
            chunkCollectors_.insert(
                std::make_pair( c, new MipChunkMeshCollector( c,
                                                              meshWriter_ )));
        }
    ...
    void processSingleSegment( int id, double scale, zi::vl::vec3d trans,
                               ...
                               std::vector< MipChunkMeshCollector* >* targets )
    {
        double max_err = 90.0;
