...
void OmMemMappedVolume::allocMemMapFiles(const std::map<int, Vector3i>& levDims){
...
public:
	GetChunkPtrVisitor(const OmChunkCoord& coord)
		: coord(coord) {}
...
OmRawDataPtrs OmMemMappedVolume::getChunkPtrRaw(const OmChunkCoord& coord){
