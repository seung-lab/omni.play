...
OmMipChunkCoord::ParentCoord() const {
	...
	return OmMipChunkCoord(Level+1, 
						   Coordinate.x/2, 
						   Coordinate.y/2, 
						   Coordinate.z/2);
...
void 
OmMipChunkCoord::SiblingCoords(OmMipChunkCoord *pSiblings) const {
...
void 
OmMipChunkCoord::ChildrenCoords(OmMipChunkCoord *pChildren) const {
	//get primary child
...
void 
OmMipChunkCoord::operator=( const OmMipChunkCoord& rhs ) {
	Level = rhs.Level;
	Coordinate = rhs.Coordinate;
}

bool 
OmMipChunkCoord::operator==( const OmMipChunkCoord& rhs ) const {
...
ostream& 
operator<<(ostream &out, const OmMipChunkCoord &in) {
	out << "[ " << in.Level;
