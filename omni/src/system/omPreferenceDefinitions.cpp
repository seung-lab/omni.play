...
void OmPreferenceDefaults::setDefaultMeshPreferences()
{
	SET_INT(om::PREF_MESH_NUM_SMOOTHING_ITERS_INT, 50);
	SET_FLOAT(om::PREF_MESH_PRESERVED_SHARP_ANGLE_FLT, 30.0f);
	SET_FLOAT(om::PREF_MESH_REDUCTION_PERCENT_FLT, 35.0f);
}
