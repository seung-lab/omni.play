...
namespace OM {
	enum PrefEnum {
		...
		//MESH
		PREF_MESH_NUM_SMOOTHING_ITERS_INT = 200,
		PREF_MESH_PRESERVED_SHARP_ANGLE_FLT = 201,
		PREF_MESH_REDUCTION_PERCENT_FLT = 202,
...
public:
	static void SetDefaultAllPreferences(){
		setDefaultMeshPreferences();
		setDefaultView2dPreferences();
		setDefaultView3dPreferences();
	}

private:
	static void setDefaultMeshPreferences();
