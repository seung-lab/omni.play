...
OmKeyManager *OmKeyManager::Instance()
{
	if (NULL == mspInstance) {
...
void OmKeyManager::MapKeySequence(OmKeySequence omKeySeq, QKeyEvent * keyEvent)
{
...
void OmKeyManager::MapKeySequence(OmKeySequence omKeySeq, QKeySequence qKeySeq)
{
	//create string from sequence
...
void OmKeyManager::MapKeySequence(OmKeySequence omKeySeq, int value)
{
	//create seq
...
void OmKeyManager::MapKeySequence(OmKeySequence omKeySeq, string keySequenceStr)
{
	//map enum to string
 ...
 */
OmKeySequence OmKeyManager::LookupKeySequence(QKeyEvent * keyEvent)
{
 ...
 */
QKeySequence OmKeyManager::OmToQKeySequence(OmKeySequence omKeySeq)
{
