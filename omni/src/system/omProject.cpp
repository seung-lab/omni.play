...
//project
const string& 
OmProject::GetFileName() {
	return Instance()->mFileName;
}

void 
OmProject::SetFileName(const string &fname) {
	Instance()->mFileName = fname;
}

const string& 
OmProject::GetDirectoryPath() {
	return Instance()->mDirectoryPath;
}

void 
OmProject::SetDirectoryPath(const string &dpath) {
	Instance()->mDirectoryPath = dpath;
}


string 
OmProject::GetTempDirectoryPath() {
...
void
OmProject::New(string dpath, string fname) {
	
	//delete previous project
	if(OmProjectData::IsOpen()) Close();
...
void 
OmProject::SaveAs(string dpath, string fname) {
 ...
 */
void 
OmProject::Load(string dpath, string fname) {
	
	//close prev project if one is open
	if(OmProjectData::IsOpen()) OmProjectData::Close();
