...
bool
OmPreferences::ValidPreference(const int key) {
	return Instance()->mPreferenceMap.count(key);
}


const OmPrefItem&
OmPreferences::GetItem(const int key, const OmPrefItem::OmPrefItemType &type) {
	//check key exists
...
void 
OmPreferences::SetItem(const int key, const OmPrefItem &item) {
	//set preference
...
void
OmPreferences::RefreshPreference(const int key) {
	//check key exists
	if(!ValidPreference(key)) {
		cout << "OmPreferences::GetItem: Preference key: " << key << " does not exist." << endl;
		assert(false);
...
const string& 
OmPreferences::GetString(const int key) {
	return GetItem(key, OmPrefItem::STRING_TYPE).mString;
}
	
void 
OmPreferences::SetString(const int key, const string &value) {
	OmPrefItem item;
...
void
OmPreferences::Get(const int key, string &value) {
	value = GetString(key);
}

void
OmPreferences::Set(const int key, const string &value) {
	SetString(key, value);
}

void
OmPreferences::Set(const int key, const char *c_str) {
	SetString(key, c_str);
}
...
float 
OmPreferences::GetFloat(const int key) {
	return GetItem(key, OmPrefItem::FLOAT_TYPE).mFloat;
}

void 
OmPreferences::SetFloat(const int key, const float value) {
	OmPrefItem item;
...
void
OmPreferences::Get(const int key, float &value) {
	value = GetFloat(key);
}

void 
OmPreferences::Set(const int key, const float value) {
	SetFloat(key, value);
}
...
int 
OmPreferences::GetInteger(const int key) {
	return GetItem(key, OmPrefItem::INTEGER_TYPE).mInteger;
}

void 
OmPreferences::SetInteger(const int key, const int value) {
	OmPrefItem item;
...
void
OmPreferences::Get(const int key, int &value) {
	value = GetInteger(key);
}

void 
OmPreferences::Set(const int key, const int value) {
...
bool 
OmPreferences::GetBoolean(const int key) {
	return GetItem(key, OmPrefItem::BOOLEAN_TYPE).mBoolean;
}

void 
OmPreferences::SetBoolean(const int key, const bool value) {
	OmPrefItem item;
...
void
OmPreferences::Get(const int key, bool &value) {
	value = GetBoolean(key);
}

void 
OmPreferences::Set(const int key, const bool value) {
...
const Vector3f& 
OmPreferences::GetVector3f(const int key) {
	return GetItem(key, OmPrefItem::VECTOR3F_TYPE).mVector3f;
}

void 
OmPreferences::SetVector3f(const int key, const Vector3f &value) {
	OmPrefItem item;
...
void 
OmPreferences::Get(const int key, Vector3f &value) {
	value = GetVector3f(key);
}

void 
OmPreferences::Set(const int key, const Vector3f &value) {
