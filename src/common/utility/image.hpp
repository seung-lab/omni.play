...
public:
    ...
    imageCopiedData(dimension<D> extent)
        : extent_(extent)
        , data_()
    {
    ...
    imageCopiedData(dimension<D> extent, T* data)
        : extent_(extent)
        , data_()
    {
        data_ = boost::shared_ptr<container_t>
    ...
    imageCopiedData(boost::shared_ptr<container_t> data, dimension<D> extent)
        : extent_(extent)
        , data_(data)
    {}
...
public:
    ...
    imageRefData(dimension<D> extent)
        : extent_(extent)
        , data_()
    {}

    imageRefData(dimension<D> extent, T* data)
        : extent_(extent)
        , data_()
    {
        data_ = boost::shared_ptr<container_t>
    ...
    imageRefData(boost::shared_ptr<container_t> data, dimension<D> extent)
        : extent_(extent)
        , data_(data)
    {}
...
public:
    ...
    imageConstRefData(dimension<D> extent)
        : extent_(extent)
        , data_()
    {}

    imageConstRefData(dimension<D> extent, T* data)
        : extent_(extent)
        , data_()
    {
        data_ = boost::shared_ptr<container_t>
    ...
    imageConstRefData(boost::shared_ptr<container_t> data, dimension<D> extent)
        : extent_(extent)
        , data_(data)
    {}
...
public:
    ...
    image(dimension<D> extent)
        : d_(container_t<T,D>(extent))
    {}

    image(dimension<D> extent, T* data)
        : d_(container_t<T,D>(extent, data))
    {}

    image(boost::shared_ptr<boost::multi_array<T,D> > data, dimension<D> extent)
    ...
    boost::shared_ptr<T> getMallocCopyOfData() const
    {
        ...
        boost::shared_ptr<T> ret =
            smartPtr<T>::MallocNumBytes(numBytes);
    ...
    void copyFrom(image<T,D> src, dimension<D> targetPos,
                  dimension<D> srcPos, dimension<D> size)
    {
