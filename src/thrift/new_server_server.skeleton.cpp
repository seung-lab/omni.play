...
class new_serverHandler : virtual public new_serverIf {
 public:
  new_serverHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<new_serverHandler> handler(new new_serverHandler());
  shared_ptr<TProcessor> processor(new new_serverProcessor(handler));
