...
class old_serverHandler : virtual public old_serverIf {
 public:
  old_serverHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<old_serverHandler> handler(new old_serverHandler());
  shared_ptr<TProcessor> processor(new old_serverProcessor(handler));
