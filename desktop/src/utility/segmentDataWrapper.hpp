...
class SegmentDataWrapper {
 ...
 public:
  ...
  inline bool IsValidWrapper() const { return IsSegmentValid(); }

  inline QString getName() const { return GetSegment()->GetName(); }
  ...
  inline QString getNote() const { return GetSegment()->GetNote(); }

  inline void setNote(const QString& str) const { GetSegment()->SetNote(str); }
  ...
  inline OmSegments* Segments() const { return GetSegmentation().Segments(); }
  ...
  inline void RandomizeColor() const { GetSegment()->reRandomizeColor(); }
