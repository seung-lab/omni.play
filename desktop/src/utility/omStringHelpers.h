...
public:
    ...
    static uint32_t getUInt(const QString& arg)
    {
        ...
        throw om::IoException("could not parse to uint32_t", arg.toStdString());
    }
    ...
    static int32_t getInt(const QString& arg)
    {
        ...
        throw om::IoException("could not parse to int32_t", arg.toStdString());
    }
    ...
    static double getDouble(const QString& arg)
    {
        ...
        throw om::IoException("could not parse to double", arg.toStdString());
    }
    ...
    static float getFloat(const QString& arg)
    {
        ...
        throw om::IoException("could not parse to float", arg.toStdString());
    }
};
