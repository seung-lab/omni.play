...
class SegmentationDataWrapper {
 ...
 public:
  ...
  inline void set(const SegmentationDataWrapper& sdw) { id_ = sdw.id_; }
  ...
  inline QString getNote() const { return GetSegmentation().GetNote(); }
  ...
  inline OmMST* MST() const { return GetSegmentation().MST(); }
