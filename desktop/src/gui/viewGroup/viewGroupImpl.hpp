...
public:
        ...
        , mainWindowUtils_(new ViewGroupMainWindowUtils(mainWindow, vgs, utils_.get()))
    {
        ...
        om::connect(this, SIGNAL(signalAddView2Dchannel(ChannelDataWrapper, om::common::ViewType)),
                    this, SLOT(addView2Dchannel(ChannelDataWrapper, om::common::ViewType)));

        om::connect(this, SIGNAL(signalAddView2Dsegmentation(SegmentationDataWrapper, om::common::ViewType)),
                    this, SLOT(addView2Dsegmentation(SegmentationDataWrapper, om::common::ViewType)));
    }
...
private Q_SLOTS:
    ...
    void addView2Dchannel(const ChannelDataWrapper& cdw, const om::common::ViewType viewType)
    {
    ...
    void addView2Dsegmentation(const SegmentationDataWrapper& sdw, const om::common::ViewType viewType)
    {
...
Q_SIGNALS:
    ...
    void signalAddView2Dchannel(const ChannelDataWrapper& cdw, const om::common::ViewType viewType);
    void signalAddView2Dsegmentation(const SegmentationDataWrapper& sdw, const om::common::ViewType viewType);
