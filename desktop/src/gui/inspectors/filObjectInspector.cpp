...
FilObjectInspector::FilObjectInspector(QWidget* parent,
  ...
  om::connect(chanEdit, SIGNAL(editingFinished()), this,
              SLOT(sourceEditChangedChan()));
  om::connect(segEdit, SIGNAL(editingFinished()), this,
              SLOT(sourceEditChangedSeg()));
  om::connect(alphaSlider, SIGNAL(valueChanged(int)), this,
              SLOT(setFilAlpha(int)));
  om::connect(alphaSlider, SIGNAL(sliderReleased()), this,
              SLOT(saveFilterAlphaValue()));
}
