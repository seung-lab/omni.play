    ...
    : QWidget(parent)
{
    ...
    om::connect(discoCheckBox, SIGNAL(stateChanged(int)),
                this, SLOT(on_discoCheckBox_stateChanged()));

    om::connect(crosshairSlider, SIGNAL(valueChanged(int)),
                this, SLOT(on_crosshairSlider_valueChanged()));
    om::connect(viewSquareCheckBox, SIGNAL(stateChanged(int)),
                this, SLOT(on_viewSquareCheckBox_stateChanged()));
    om::connect(viewPaneCheckBox, SIGNAL(stateChanged(int)),
                this, SLOT(on_viewPaneCheckBox_stateChanged()));
    om::connect(crosshairCheckBox, SIGNAL(stateChanged(int)),
