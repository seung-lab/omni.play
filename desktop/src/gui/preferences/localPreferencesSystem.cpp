    ...
    : QWidget(parent)
{
    ...
    om::connect(meshSlider, SIGNAL(valueChanged(int)),
            this, SLOT( on_meshSlider_valueChanged()));
    om::connect(tileSlider, SIGNAL(valueChanged(int)),
            this, SLOT(on_tileSlider_valueChanged()));

    om::connect(meshSlider, SIGNAL(sliderReleased()),
            this, SLOT( on_meshSlider_sliderReleased()));
    om::connect(tileSlider, SIGNAL(sliderReleased()),
            this, SLOT(on_tileSlider_sliderReleased()));
}
