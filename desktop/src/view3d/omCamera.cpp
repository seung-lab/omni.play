...
OmCamera::OmCamera() : mZoomer(this), mPanner(this), mArcBall(this) {
 ...
 */
Vector4<int> OmCamera::GetViewport() const { return mViewport; }
...
void OmCamera::ApplyViewport() {
  glViewport(mViewport.lowerLeftX, mViewport.lowerLeftY, mViewport.width,
             mViewport.height);
}
 ...
 */
Vector4<float> OmCamera::GetPerspective() const { return mPerspective; }
...
void OmCamera::ApplyPerspective() {
  ...
  glLoadIdentity();
  gluPerspective(mPerspective[0], mPerspective[1], mPerspective[2],
                 10000000);  //glFrustum()
...
Vector3f OmCamera::GetFocus() { return -mFocusMatrix.getTranslation(); }
...
float OmCamera::GetDistance() { return -mZoomMatrix.ml[14]; }
...
Quaternionf OmCamera::GetOrbitRotation() { return mOrbitRotation; }
...
Quaternionf OmCamera::GetLookAtRotation() { return mLookAtRotation; }
...
void OmCamera::MovementStart(CameraMovementType type,
