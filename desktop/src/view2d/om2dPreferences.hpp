...
class Om2dPreferences : private om::singletonBase<Om2dPreferences> {
 ...
 public:
  ...
  static bool HaveAlphaGoToBlack() { return instance().haveAlphaGoToBlack_; }
  ...
  // show crosshairs
  static bool ShowCrosshairs() { return instance().showView2dCrosshairs_; }
  ...
  static int CrosshairHoleSize() { return instance().crosshairHoleSize_; }
  ...
  // cross hair opening size
  static double MipRate() { return instance().mipRate_; }
  ...
  // cross hair opening size
  static double ScrollRate() { return instance().scrollRate_; }
 ...
 private:
  ...
  void setDefaultCrosshairHoleSize() {
    ...
    crosshairHoleSize_ = LocalPrefFiles::readSettingNumber<int32_t>(
        "View2dCrosshairHoleSize", defaultVal);
  }

  void setDefaultMipRate() {
    const int defaultVal = 3;
    mipRate_ = LocalPrefFiles::readSettingNumber<double>("MipRate", defaultVal);
  }

  void setDefaultScrollRate() {
    const int defaultVal = 3;
    scrollRate_ =
        LocalPrefFiles::readSettingNumber<double>("ScrollRate", defaultVal);
  }
