...
class OmTileDrawer {
 public:
  ...
  ~OmTileDrawer() { OmTileCache::UnRegisterDrawer(this); }
  ...
  int GetTileCount() { return tileCount_; }

  int GetTileCountIncomplete() { return tileCountIncomplete_; }

  bool IsDrawComplete() { return 0 == tileCountIncomplete_; }

  OmView2dState* GetState() { return state_; }
