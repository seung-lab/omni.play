...
class OmVolCoords {
 ...
 public:
  ...
  void SetChunkDimension(const int dim) { chunkDim_ = dim; }

  // coordinate frame methods

  inline Matrix4f DataToGlobalMat() const { return dataToGlobal_; }

  inline Matrix4f GlobalToDataMat() const { return globalToData_; }
