...
class OmSegmentPageConverter {
 public:
  om::shared_ptr<OmSegmentDataV4> static ConvertPageV3toV4(
      om::shared_ptr<OmSegmentDataV3> dataV3, const uint32_t pageSize) {
  ...
  om::shared_ptr<uint8_t> static ConvertPageV3toV4ListType(
      om::shared_ptr<OmSegmentDataV3> dataV3, const uint32_t pageSize) {
    OmSegmentDataV3* rawV3 = dataV3.get();
