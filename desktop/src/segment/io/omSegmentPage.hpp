...
public:
    ...
    void Create()
    {
        ...
        for(uint32_t i = 0; i < pageSize_; ++i)
        {
            ...
            objectPool_[i].data_->bounds = om::coords::DataBbox(segmentation_, 0);
        }
    }
...
private:
    ...
    void loadSegmentsData()
    {
       switch(versionInfo_->Get()){
        case 0:
            throw ArgException("bad segment page version number");
        case 1:
            convertFromHDF5();
            break;
        case 2:
        ...
        case 4:
            ...
            break;
        default:
            throw ArgException("unknown segment page version number: " +
