...
class OmUserEdges {
 ...
 public:
  OmUserEdges(OmSegmentation* vol) : vol_(vol) {}
  ...
  void AddEdge(const OmSegmentEdge& e) { edges_.push_back(e); }

  int RemoveEdge(const OmSegmentEdge& edge) { return edges_.removeAll(edge); }

  QList<OmSegmentEdge>& Edges() { return edges_; }
