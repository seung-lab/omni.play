...
om::common::SegID OmSegmentLists::GetNextSegIDinWorkingList(const SegmentDataWrapper& sdw)
{
    zi::rwmutex::read_guard g(lock_);
...
om::common::SegID OmSegmentLists::GetNextSegIDinWorkingList(const SegmentationDataWrapper& sdw)
{
    zi::rwmutex::read_guard g(lock_);
