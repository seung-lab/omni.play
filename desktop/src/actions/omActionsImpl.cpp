...
void OmActionsImpl::SelectSegments(std::shared_ptr<OmSelectSegmentsParams> params){
    (new OmSegmentSelectAction(params))->Run();
}

// group-related
void OmActionsImpl::CreateOrDeleteSegmentGroup(const om::common::ID segmentationID,
