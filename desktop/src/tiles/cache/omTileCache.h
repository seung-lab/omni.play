...
class OmTileCache : private om::singletonBase<OmTileCache> {
 private:
  ...
  static inline OmTileCacheImpl* impl() { return instance().impl_.get(); }
 ...
 public:
  ...
  static void WidgetVisibilityChanged(OmTileDrawer* drawer, const bool visible);

  static void Get(OmTilePtr& tile, const OmTileCoord& key,
