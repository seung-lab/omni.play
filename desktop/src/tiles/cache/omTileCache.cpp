...
void OmTileCache::Delete() { instance().impl_.reset(); }

void OmTileCache::Reset() { instance().impl_.reset(new OmTileCacheImpl()); }
...
void OmTileCache::RegisterDrawer(OmTileDrawer* d) { impl()->RegisterDrawer(d); }

void OmTileCache::UnRegisterDrawer(OmTileDrawer* d) {
  impl()->UnRegisterDrawer(d);
}

void OmTileCache::SetDrawerDone(OmTileDrawer* d) { impl()->SetDrawerDone(d); }
...
bool OmTileCache::AreDrawersActive() { return impl()->AreDrawersActive(); }

void OmTileCache::ClearAll() { impl()->ClearAll(); }

void OmTileCache::ClearSegmentation() { impl()->ClearSegmentation(); }

void OmTileCache::ClearChannel() { impl()->ClearChannel(); }
