...
class OmException : public std::exception {
 public:
  OmException(const std::string& name, const std::string& msg)
...
class OmArgException : public OmException {
 public:
  OmArgException(const std::string& msg) : OmException("OmArgException", msg) {}
  OmArgException(const QString& str1, const QString& str2)
...
class OmIoException : public OmException {
 public:
  ...
  OmIoException(const std::string& msg) : OmException("OmIoException", msg) {}
  OmIoException(const QString& str)
      : OmException("OmIoException", str.toStdString()) {}
  OmIoException(const QString& str1, const QString& str2)
      : OmException("OmIoException", QString(str1 + " " + str2).toStdString()) {
  }
  OmIoException(const QString& str1, const std::string& str2)
      : OmException("OmIoException", str1.toStdString() + " " + str2) {}

  // TODO: what if string conversion throws exception? (purcaro)
  template <typename T>
  OmIoException(const QString& str1, const T num)
