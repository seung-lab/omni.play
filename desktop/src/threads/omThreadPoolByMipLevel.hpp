...
class OmThreadPoolByMipLevel {
 ...
 public:
  OmThreadPoolByMipLevel() { OmThreadPoolManager::Add(this); }
  ...
  inline void insert(const int mipLevel,
                     const std::shared_ptr<zi::runnable>& job) {
