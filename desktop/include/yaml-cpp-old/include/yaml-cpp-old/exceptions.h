#ifndef EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66_OLD
#define EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66_OLD
...
namespace YAMLold
{
	...
	private:
		static const std::string build_what(const Mark& mark, const std::string& msg) {
			...
			output << "yaml-cpp-old: error at line " << mark.line+1 << ", column " << mark.column+1 << ": " << msg;
			return output.str();
		}
	};
...
#endif // EXCEPTIONS_H_62B23520_7C8E_11DE_8A39_0800200C9A66_OLD
